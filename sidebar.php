...
<div class="Container-lg">
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
        ...
        <li class="nav-item">
            <a class="nav-link ps-2 <?php echo (isset ($_GET['x'])&& $_GET['x']=='riwayat') ? 'active link-light':'link-dark' ; ?>" href="riwayat"><i class="bi bi-person-fill"></i> Riwayat Pesanan Selesai</a>
        </li>
        <li class="nav-item">
